    ...
    public function run(): void
    {
        $cats = [
            ...
            [
                ...
                'form' => 'Cair',
                'package_unit' => 'Galon',
                'package_weight_gross' => 5.20,
                'package_weight_net' => 5.00,
                'volume' => 5.00,
                'volume_unit' => 'L',
                'store' => 'Toko Cat Sejahtera',
                'address' => 'Jl. Raya Cilandak No. 123, Jakarta Selatan',
                'short_address' => 'Cilandak, Jakarta Selatan',
            ...
            [
                ...
                'form' => 'Cair',
                'package_unit' => 'Pail',
                'package_weight_gross' => 26.00,
                'package_weight_net' => 25.00,
                'volume' => 25.00,
                'volume_unit' => 'L',
                'store' => 'Toko Cat Sejahtera',
                'address' => 'Jl. Raya Cilandak No. 123, Jakarta Selatan',
            ...
            [
                ...
                'short_address' => 'Fatmawati, Jakarta Selatan',
            ...
            [
                ...
                'form' => 'Cair',
                'package_unit' => 'Pail',
                'package_weight_gross' => 21.00,
                'package_weight_net' => 20.00,
                'volume' => 20.00,
                'volume_unit' => 'L',
                'store' => 'Mandiri Bangunan',
                'address' => 'Jl. Fatmawati Raya No. 45, Jakarta Selatan',
            ...
            [
                ...
                'form' => 'Cair',
                'package_unit' => 'Galon',
                'package_weight_gross' => 5.30,
                'package_weight_net' => 5.00,
                'volume' => 5.00,
                'volume_unit' => 'L',
                'store' => 'Indo Bangunan',
                'address' => 'Jl. TB Simatupang No. 88, Jakarta Selatan',
                'short_address' => 'TB Simatupang, Jakarta Selatan',
            ...
            [
                ...
                'form' => 'Cair',
                'package_unit' => 'Klg',
                'package_weight_gross' => 1.10,
                'package_weight_net' => 1.00,
                'volume' => 1.00,
                'volume_unit' => 'L',
                'store' => 'Indo Bangunan',
                'address' => 'Jl. TB Simatupang No. 88, Jakarta Selatan',
        ...
        foreach ($cats as $cat) {
            DB::table('cats')->insert(array_merge($cat, [
                'created_at' => now(),
                'updated_at' => now(),
            ]));
        }
