...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('brick_calculations', function (Blueprint $table) {
            ...
            // Jenis pemasangan
            $table->foreignId('installation_type_id')
                  ->constrained('brick_installation_types')
                  ->onDelete('cascade');
            ...
            $table->foreignId('mortar_formula_id')
                  ->constrained('mortar_formulas')
                  ->onDelete('cascade');
            ...
            $table->foreignId('brick_id')->nullable()
                  ->constrained('bricks')
                  ->onDelete('set null');
            ...
            $table->foreignId('cement_id')->nullable()
                  ->constrained('cements')
                  ->onDelete('set null');
            ...
            $table->foreignId('sand_id')->nullable()
                  ->constrained('sands')
                  ->onDelete('set null');
