...
test('store brick without package type defaults to eceran', function () {
    $this->actingAsUserWithPermissions(['materials.manage']);

    $this->post(route('bricks.store'), [
        'type' => 'Merah',
        'brand' => 'Brand Default Package',
        'form' => 'Persegi',
        'dimension_length' => 20,
        'dimension_width' => 10,
        'dimension_height' => 5,
    ...
    $brick = Brick::query()->where('brand', 'Brand Default Package')->firstOrFail();
