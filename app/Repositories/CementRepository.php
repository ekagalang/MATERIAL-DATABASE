 ...
 * Cement Repository
 */
class CementRepository extends BaseRepository
{
    public function __construct(Cement $model)
    {
        $this->model = $model;
    }
    ...
    public function search(
        ...
        return $this->model
            ->where(function ($q) use ($query) {
                $q->where('cement_name', 'like', "%{$query}%")
    ...
    public function getFieldValues(
        ...
        return \App\Support\Material\MaterialAutocompleteValueFormatter::formatValues('cement', $field, $values);
    }
