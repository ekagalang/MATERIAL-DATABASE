...
class BrickTrialFormula implements FormulaInterface
{
    ...
    public function trace(array $params): array
    {
        ...
        $trace['steps'][] = [
            ...
            'formula' => 'Panjang dinding / ((Panjang bata + tebal adukan)/100)',
            'info' => 'Jika hasilnya desimal, dibulatkan keatas',
            'calculations' => [
                'Perhitungan' => "$panjangDinding / (($panjangBata + $tebalAdukan) / 100)",
        ...
        $trace['steps'][] = [
            ...
            'formula' => '(tinggi dinding / ((tinggi bata + tebal adukan) / 100)) + 1',
            'info' => 'Jika hasilnya desimal, dibulatkan keatas',
            'calculations' => [
                'Perhitungan' => "($tinggiDinding / (($tinggiBata + $tebalAdukan) / 100)) + 1",
        ...
        $trace['steps'][] = [
            ...
            'formula' => '(Panjang dinding / ((Panjang bata + tebal adukan) / 100)) + 1',
            'info' => 'Jika hasilnya desimal, dibulatkan keatas',
            'calculations' => [
                'Perhitungan' => "($panjangDinding / (($panjangBata + $tebalAdukan) / 100)) + 1",
