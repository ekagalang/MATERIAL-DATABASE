 ...
 */
class AdhesiveMixFormula implements FormulaInterface
{
    ...
    {
        return 'Perekat Keramik';
    }

    public static function getDescription(): string
    {
        return 'Menghitung Perekat Keramik dengan input panjang, tinggi, dan tebal adukan.';
    }
    ...
    public function trace(array $params): array
    {
        ...
        // Kubik air per kemasan (50% dari volume semen)
        ...
        $trace['steps'][] = [
            ...
            'info' => 'Ratio 1 : 50% (Semen : Air)',
            'calculations' => [
                'Kubik Semen' => NumberHelper::format($kubikSemenPerKemasan) . ' M3',
                'Kubik Air (50%)' => NumberHelper::format($kubikAirPerKemasan) . ' M3',
