 ...
 */
class InstantPlasteringFormula implements FormulaInterface
{
    public static function getCode(): string
    {
        return 'instant_plastering';
    }

    public static function getName(): string
    {
        return 'Plester Instan';
    }

    public static function getDescription(): string
    {
        return 'Menghitung Plester Instan dengan input panjang, tinggi, dan tebal adukan.';
    }
