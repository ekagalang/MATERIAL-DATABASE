 ...
 * Menghitung kebutuhan material untuk acian lantai (hanya semen + air)
 */
class InstantScreedFormula implements FormulaInterface
{
    public static function getCode(): string
    {
        return 'instant_screed';
    }

    public static function getName(): string
    {
        return 'Screed Instan';
    }

    public static function getDescription(): string
    {
        return 'Menghitung Screed Instan dengan input panjang, tinggi, dan tebal adukan.';
    }
    ...
    public function trace(array $params): array
    {
        ...
        // Kubik air per kemasan (20% dari volume semen)
        $kubikAirPerKemasan = $n($kubikSemenPerKemasan * 0.2);
        ...
        $trace['steps'][] = [
            ...
            'info' => 'Ratio 1 : 20% (Semen : Air)',
            'calculations' => [
                'Kubik Semen' => NumberHelper::format($kubikSemenPerKemasan) . ' M3',
                'Kubik Air (20%)' => NumberHelper::format($kubikAirPerKemasan) . ' M3',
