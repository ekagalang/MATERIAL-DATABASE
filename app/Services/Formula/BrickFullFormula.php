...
class BrickFullFormula implements FormulaInterface
{
    ...
    public function trace(array $params): array
    {
        ...
        $barisHorizontalBataRaw = $n(($panjangDinding - $tebalAdukan / 100) / (($lebarBata + $tebalAdukan) / 100));
        ...
        $kolomVertikalAdukanRaw = $n(($panjangDinding - $tebalAdukan / 100) / (($lebarBata + $tebalAdukan) / 100) + 1);
        ...
        $volumeAdukanPekerjaan = $n($luasAdukan * ($panjangBata / 100));
