...
class BrickCalculationTracer
{
    ...
    public static function traceProfessionalMode(array $params): array
    {
        ...
        $trace['steps'][] = [
            ...
            'calculations' => [
                'Perhitungan' =>
                    NumberHelper::format($mortarVolumePerBrick) . ' × ' . NumberHelper::format($totalBricks),
        ...
        $trace['steps'][] = [
            ...
            'calculations' => [
                ...
                'Volume Tersisa untuk Bata' =>
                    ...
                    ' M3',
                'Perhitungan' =>
                    NumberHelper::format($volumeForBricks) . ' / ' . NumberHelper::format($mortarVolumePerBrick),
        ...
        $trace['steps'][] = [
            ...
            'calculations' => [
                'Perhitungan' =>
                    NumberHelper::format($jumlahPasanganBata) . ' × ' . NumberHelper::format($luasPasanganPerBata),
        ...
        $trace['steps'][] = [
            ...
            'calculations' => [
                'Perhitungan' =>
                    NumberHelper::format($cementSakPerM2) . ' sak/M2 × ' . NumberHelper::format($wallArea) . ' M2',
