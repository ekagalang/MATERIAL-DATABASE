...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $recents = $recents->concat(Brick::latest()->take(3)->get()->map(function($item) {
            $item->category = 'Bata';
        ...
        $recents = $recents->concat(Cat::latest()->take(3)->get()->map(function($item) {
            $item->category = 'Cat';
        ...
        $recents = $recents->concat(Cement::latest()->take(3)->get()->map(function($item) {
            $item->category = 'Semen';
        ...
        $recents = $recents->concat(Sand::latest()->take(3)->get()->map(function($item) {
            $item->category = 'Pasir';
