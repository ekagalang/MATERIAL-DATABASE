            ...
            <div class="left-column">
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div style="position: relative;">
                        <input type="text" name="brand" value="{{ old('brand', $ceramic->brand) }}" class="autocomplete-input" data-field="brand" required 
                ...
                <div class="row" style="margin-bottom: 20px; display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div>
                        <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 14px; color: #334155;">Sub Merek</label>
                        <input type="text" name="sub_brand" value="{{ old('sub_brand', $ceramic->sub_brand) }}" 
                               style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
                    </div>
                    <div>
                        <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 14px; color: #334155;">Kode</label>
                        <input type="text" name="code" value="{{ old('code', $ceramic->code) }}" 
                               style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 20px; display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div>
                        ...
                        <select name="type" style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px; background: white;">
                            <option value="Lantai" {{ $ceramic->type == 'Lantai' ? 'selected' : '' }}>Lantai</option>
                            <option value="Dinding" {{ $ceramic->type == 'Dinding' ? 'selected' : '' }}>Dinding</option>
                            <option value="Granit" {{ $ceramic->type == 'Granit' ? 'selected' : '' }}>Granit</option>
                            <option value="Teras" {{ $ceramic->type == 'Teras' ? 'selected' : '' }}>Teras</option>
                        </select>
                    </div>
                    <div>
                        <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 14px; color: #334155;">Warna</label>
                        <input type="text" name="color" value="{{ old('color', $ceramic->color) }}" 
                               style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <select name="form" style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px; background: white;">
                        <option value="Persegi" {{ $ceramic->form == 'Persegi' ? 'selected' : '' }}>Persegi</option>
                        <option value="Persegi Panjang" {{ $ceramic->form == 'Persegi Panjang' ? 'selected' : '' }}>Persegi Panjang</option>
                        <option value="Hexagon" {{ $ceramic->form == 'Hexagon' ? 'selected' : '' }}>Hexagon</option>
                    </select>
                </div>
                ...
                <div style="margin-top: 20px; padding-top: 20px; border-top: 1px dashed #e2e8f0;">
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        <input type="text" name="store" value="{{ old('store', $ceramic->store) }}" class="autocomplete-input" data-field="store" 
                               style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
                    </div>
                    <div class="row">
                        <label style="display: block; margin-bottom: 8px; font-weight: 500; font-size: 14px; color: #334155;">Alamat</label>
                        <textarea name="address" rows="2" style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">{{ old('address', $ceramic->address) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="right-column">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div style="display: flex; align-items: flex-end; gap: 8px;">
                        <div style="flex: 1;">
                            ...
                            <input type="number" step="0.1" name="dimension_length" id="dimension_length" value="{{ old('dimension_length', $ceramic->dimension_length) }}" required 
                        ...
                        <div style="flex: 1;">
                            ...
                            <input type="number" step="0.1" name="dimension_width" id="dimension_width" value="{{ old('dimension_width', $ceramic->dimension_width) }}" required 
                                   style="width: 100%; padding: 10px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
                        </div>
                    </div>
                    <div style="margin-top: 8px;">
                        <span style="font-size: 12px; color: #64748b; display: block; margin-bottom: 4px; font-style: italic;">Tebal (mm)</span>
                        <input type="number" step="0.1" name="dimension_thickness" value="{{ old('dimension_thickness', $ceramic->dimension_thickness) }}" 
                               style="width: 100%; padding: 10px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
                    </div>
                </div>
                ...
                <div style="background: #f8fafc; padding: 15px; border-radius: 12px; border: 1px solid #f1f5f9; margin-bottom: 20px;">
                    <div style="display: flex; gap: 10px; margin-bottom: 10px;">
                        <div style="flex: 1;">
                            ...
                            <input type="text" name="packaging" value="{{ old('packaging', $ceramic->packaging) }}" style="width: 100%; padding: 8px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 13px;">
                        </div>
                        <div style="flex: 1;">
                            <label style="font-size: 12px; color: #64748b; display: block; margin-bottom: 4px;">Isi (Pcs)</label>
                            <input type="number" name="pieces_per_package" id="pieces_per_package" value="{{ old('pieces_per_package', $ceramic->pieces_per_package) }}" required 
                    ...
                    <div>
                        ...
                        <input type="number" step="0.0001" name="coverage_per_package" id="coverage_per_package" value="{{ old('coverage_per_package', $ceramic->coverage_per_package) }}" 
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" name="price_per_package" id="price_per_package" value="{{ old('price_per_package', $ceramic->price_per_package) }}" required 
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="text" id="comparison_price_per_m2" value="{{ number_format($ceramic->comparison_price_per_m2, 2) }}" readonly 
                ...
                <div class="image-upload-container" style="border: 2px dashed #e2e8f0; border-radius: 12px; padding: 20px; text-align: center; position: relative; background: #fafbfc; transition: all 0.2s; cursor: pointer;" onclick="document.getElementById('photo').click()">
                    <div id="imagePreview" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 120px;">
                        @if($ceramic->photo)
                            <img id="preview-img" src="{{ Storage::url($ceramic->photo) }}" alt="Preview" style="max-width: 100%; max-height: 150px; border-radius: 8px; object-fit: contain;">
                        @else
                            <i class="bi bi-cloud-arrow-up" style="font-size: 32px; color: #94a3b8; margin-bottom: 8px;"></i>
                            <span style="font-size: 13px; color: #64748b;">Klik untuk ganti foto</span>
                            <img id="preview-img" src="" style="display: none; max-width: 100%; max-height: 150px; border-radius: 8px; margin-top: 10px; object-fit: contain;">
                        @endif
                    </div>
                ...
                <div style="display: flex; justify-content: center; gap: 20px; margin-top: 30px; padding-bottom: 10px;">
                    ...
                    <button type="submit" class="btn-save" 
                            style="padding: 12px 40px; border-radius: 10px; font-weight: 600; color: white; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border: none; box-shadow: 0 4px 6px -1px rgba(15, 23, 42, 0.2); cursor: pointer;">Update</button>
                </div>
            </div>
        </div>
    </form>
