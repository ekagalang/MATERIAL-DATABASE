<div class="card">
    ...
    <form action="{{ route('nats.update', $nat->id) }}" method="POST" enctype="multipart/form-data" id="natForm">
        @csrf
        @method('PUT')
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
            ...
            <div>
                ...
                {{-- Nama nat disembunyikan, akan dikirim apa adanya/otomatis --}}
                <input type="hidden" name="nat_name" id="nat_name" value="{{ old('nat_name', $nat->nat_name) }}">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" 
                               name="type" 
                               id="type" 
                               value="{{ old('type', $nat->type) }}" 
                               class="autocomplete-input" 
                               data-field="type" 
                               autocomplete="off" 
                               placeholder="Pilih atau ketik jenis nat...">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" 
                               name="sub_brand" 
                               id="sub_brand" 
                               value="{{ old('sub_brand', $nat->sub_brand) }}" 
                               class="autocomplete-input" 
                ...
                <div class="row" style="align-items: stretch; margin-top: 15px;">
                    ...
                    <div style="flex: 1; display: flex; gap: 15px;">
                        ...
                        <div style="flex: 2;">
                            @php
                                $packageUnitValue = old('package_unit', $nat->package_unit);
                            @endphp
                        ...
                        <div class="mini-input-wrapper" style="display: flex; flex-direction: column; flex: 1; position: relative;">
                            <span class="mini-label" style="font-size: 13px; font-style: italic; margin-bottom: 4px; color: inherit;">Berat Bersih (Kg)</span>
                            <div style="position: relative;">
                                <input type="text"
                                    name="package_weight_gross"
                                    id="package_weight_gross"
                                    value="{{ old('package_weight_gross', $nat->package_weight_gross) }}"
                                    class="autocomplete-input"
                ...
                <div class="row" style="align-items: stretch; margin-top: 15px;">
                    ...
                    <div style="flex: 1; display: flex; gap: 15px; align-items: stretch;">
                        ...
                        <div class="flex-fill" style="flex: 1; display: flex; align-items: stretch; position: relative;">
                            <input type="hidden" name="package_price" id="package_price" value="{{ old('package_price', $nat->package_price) }}">
                            <input type="hidden" name="price_unit" id="price_unit" value="{{ old('price_unit', $nat->price_unit) }}">
                            <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('package_price', $nat->package_price) }}"
                                       class="autocomplete-input"
                        ...
                        <div class="mini-input-wrapper flex-fill" style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
                            ...
                            <div style="display: flex; align-items: center; position: relative;">
                                <input type="hidden" name="comparison_price_per_kg" id="comparison_price_per_kg" value="{{ old('comparison_price_per_kg', $nat->comparison_price_per_kg) }}">
                                <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                    <span class="price-prefix" style="position: absolute; left: 10px; font-size: 14px; font-weight: 600; color: inherit; pointer-events: none; z-index: 1;">Rp</span>
                                    <input type="text"
...
<script src="/js/nat-form.js?v={{ time() }}"></script>
<script src="{{ asset('js/store-autocomplete.js') }}?v={{ time() }}"></script>
<script>
    if (typeof initNatForm === 'function') {
        const currentForm = document.getElementById('natForm');
        initNatForm(currentForm ? currentForm.parentElement : document);
    }
    // Initialize store autocomplete after form init
    if (typeof initStoreAutocomplete === 'function') {
        initStoreAutocomplete(document.getElementById('natForm')?.parentElement);
    }
</script>
