                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; gap: 8px; align-items: center;">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ $cement->comparison_price_per_kg ? number_format($cement->comparison_price_per_kg, 0, ',', '.') : '' }}" 
                                   inputmode="numeric" 
                                   placeholder="0" 
                                   style="flex: 1; max-width: 200px;">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" 
                               name="short_address" 
                               id="short_address" 
                               value="{{ old('short_address', $cement->short_address) }}" 
                               class="autocomplete-input" 
            ...
            <div style="flex: 0 0 calc(35% - 16px); max-width: calc(35% - 16px);">
                ...
                <div class="uploadDel" style="margin-top: 14px; display: flex; gap: 20px; font-size: 13px;">
                    ...
                    <span style="cursor: pointer; 
                                 color: #ef4444; 
                                 font-weight: 600; 
                                 display: {{ $cement->photo_url ? 'flex' : 'none' }}; 
                                 align-items: center; 
                                 gap: 6px;" 
                          id="deletePhotoBtn">
