<div class="card">
    ...
    <form action="{{ route('cements.store') }}" method="POST" enctype="multipart/form-data" id="cementForm">
        @csrf
        ...
        <div style="display: flex; gap: 40px;">
            ...
            <div style="flex: 0 0 calc(65% - 20px); max-width: calc(65% - 20px);">
                ...
                {{-- Nama semen disembunyikan, akan diisi otomatis --}}
                <input type="hidden" name="cement_name" id="cement_name" value="{{ old('cement_name') }}">
                ...
                <div class="row">
                    <label>Code</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="code" id="code" value="{{ old('code') }}" class="autocomplete-input" data-field="code" autocomplete="off" placeholder="Ketik atau pilih..." style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    <label>Warna</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="color" id="color" value="{{ old('color') }}" class="autocomplete-input" data-field="color" autocomplete="off" placeholder="Ketik atau pilih..." style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="display: flex; flex: 1; gap: 8px; align-items: center;">
                        ...
                        <input type="text" id="package_price_display" value="{{ old('package_price') }}" inputmode="numeric" placeholder="0" style="flex: 1; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                        <span style="padding: 0 4px;">/</span>
                        <div style="position: relative; flex: 0 0 50%;">
                            <input type="text" name="price_unit" id="price_unit" value="{{ old('price_unit') }}" class="autocomplete-input" data-field="price_unit" autocomplete="off" placeholder="Satuan (Sak, Kg, dll)" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
