<div class="card">
    ...
    <form action="{{ route('cats.store') }}" method="POST" enctype="multipart/form-data" id="catForm">
        @csrf
        ...
        <div style="display: flex; gap: 40px;">
            ...
            <div style="flex: 0 0 calc(65% - 20px); max-width: calc(65% - 20px);">
                ...
                <input type="hidden" name="cat_name" id="cat_name" value="{{ old('cat_name') }}">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="sub_brand" id="sub_brand" value="{{ old('sub_brand') }}" class="autocomplete-input" data-field="sub_brand" autocomplete="off" placeholder="Ketik atau pilih..." style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative; display: flex; gap: 8px;">
                        <div style="position: relative; flex: 1;">
                            <input type="text" name="color_name" id="color_name" value="{{ old('color_name') }}" class="autocomplete-input" data-field="color_name" autocomplete="off" placeholder="Nama warna" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                            <div class="autocomplete-list" id="color_name-list"></div>
                        </div>
                        <div style="position: relative; flex: 0 0 50%;">
                            <input type="text" name="color_code" id="color_code" value="{{ old('color_code') }}" class="autocomplete-input" data-field="color_code" autocomplete="off" placeholder="Kode" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="display: flex; flex: 1; gap: 8px; align-items: center;">
                        ...
                        <div style="position: relative; flex: 0 0 50%;">
                            <input type="text" name="volume_unit" id="volume_unit" value="{{ old('volume_unit') }}" class="autocomplete-input" data-field="volume_unit" autocomplete="off" placeholder="Satuan (L, ml, dll)" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
        ...
        <span style="white-space: nowrap; font-size: 13px;">Kg</span>
                ...
                <div class="row">
                    ...
                    <div style="display: flex; flex: 1; gap: 8px; align-items: center;">
                        ...
                        <div style="position: relative; flex: 0 0 50%;">
                            <input type="text" name="price_unit" id="price_unit" value="{{ old('price_unit') }}" class="autocomplete-input" data-field="price_unit" autocomplete="off" placeholder="Satuan (Pcs, Kg, dll)" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="display: flex; flex: 1; gap: 8px; align-items: center;">
                        ...
                        <input type="text" id="comparison_price_display" inputmode="numeric" placeholder="0" style="flex: 1; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                        <span style="padding: 0 4px;">/Kg</span>
                    </div>
                </div>
