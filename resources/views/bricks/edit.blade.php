            ...
            <div style="flex: 0 0 calc(65% - 20px); max-width: calc(65% - 20px);">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="type" id="type" value="{{ old('type', $brick->type) }}" class="autocomplete-input" data-field="type" autocomplete="off" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    <label>Merek</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="brand" id="brand" value="{{ old('brand', $brick->brand) }}" class="autocomplete-input" data-field="brand" autocomplete="off" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    <label>Bentuk</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="form" id="form" value="{{ old('form', $brick->form) }}" class="autocomplete-input" data-field="form" autocomplete="off" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; grid-template-columns: 1fr auto 1fr auto 1fr; gap: 6px; align-items: center;">
                            <!-- Panjang -->
                            <input type="text" id="dimension_length_input" value="{{ old('dimension_length', $brick->dimension_length) }}" placeholder="P" style="padding: 7px 8px; border: 1px solid #999; border-radius: 2px; font-size: 13px; width: 100%;">
                            ...
                            <!-- Lebar -->
                            <input type="text" id="dimension_width_input" value="{{ old('dimension_width', $brick->dimension_width) }}" placeholder="L" style="padding: 7px 8px; border: 1px solid #999; border-radius: 2px; font-size: 13px; width: 100%;">
                            ...
                            <!-- Tinggi -->
                            <input type="text" id="dimension_height_input" value="{{ old('dimension_height', $brick->dimension_height) }}" placeholder="T" style="padding: 7px 8px; border: 1px solid #999; border-radius: 2px; font-size: 13px; width: 100%;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr auto 1fr auto 1fr; gap: 6px; margin-top: 3px;">
                            <small style="color: #7f8c8d; font-size: 10px; text-align: left;">
                                Panjang <span id="length_cm_display">{{ $brick->dimension_length ? number_format($brick->dimension_length, 2, '.', '') : '-' }}</span> cm
                            </small>
                            <span style="width: 10px"></span>
                            <small style="color: #7f8c8d; font-size: 10px; text-align: left;">
                                Lebar <span id="width_cm_display">{{ $brick->dimension_width ? number_format($brick->dimension_width, 2, '.', '') : '-' }}</span> cm
                            </small>
                            <span style="width: 10px"></span>
                            <small style="color: #7f8c8d; font-size: 10px; text-align: left;">
                                Tinggi <span id="height_cm_display">{{ $brick->dimension_height ? number_format($brick->dimension_height, 2, '.', '') : '-' }}</span> cm
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div style="display: flex; flex: 1; gap: 8px; align-items: center;">
                        ...
                        <input type="text" id="price_per_piece_display" value="{{ old('price_per_piece', $brick->price_per_piece) }}" inputmode="numeric" placeholder="0" style="flex: 1; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="display: flex; flex: 1; gap: 8px; align-items: center;">
                        ...
                        <input type="text" id="comparison_price_display" inputmode="numeric" placeholder="0" value="{{ $brick->comparison_price_per_m3 ? number_format($brick->comparison_price_per_m3, 0, ',', '.') : '' }}" style="flex: 1; padding: 7px; border: 1px solid #999; border-radius: 2px; max-width: 83.5%;">
                        <span style="padding: 0 4px;">/M3</span> </span>
                    </div>
                </div>
                ...
                <div class="row">
                    <label>Toko</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="store" id="store" value="{{ old('store', $brick->store) }}" class="autocomplete-input" data-field="store" autocomplete="off" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="short_address" id="short_address" value="{{ old('short_address', $brick->short_address) }}" class="autocomplete-input" data-field="short_address" autocomplete="off" placeholder="Contoh: Roxy, CitraLand, dsb" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="address" id="address" value="{{ old('address', $brick->address) }}" class="autocomplete-input" data-field="address" placeholder="Alamat lengkap toko" autocomplete="off" style="width: 100%; padding: 7px; border: 1px solid #999; border-radius: 2px;">
            ...
            <div style="flex: 0 0 calc(35% - 20px); max-width: calc(35% - 20px);">
                <div class="right" id="photoPreviewArea" style="border: 1px solid #999; height: 380px; border-radius: 4px; display: flex; align-items: center; justify-content: center; background: #f9f9f9; cursor: pointer; position: relative; overflow: hidden; width: 100%;">
                    @if($brick->photo_url)
                        ...
                        <img id="photoPreview" src="{{ $brick->photo_url }}" alt="Preview" style="width: 100%; height: 100%; object-fit: cover;">
                    @else
                ...
                <div class="uploadDel" style="margin-top: 10px; font-size: 12px; color: #c02c2c;">
                    ...
                    <span style="cursor: pointer; {{ $brick->photo_url ? '' : 'display:none;' }}" id="deletePhotoBtn">✕ Hapus</span>
                </div>
            </div>
        </div>
