                ...
                <div class="row" style="align-items: stretch; margin-top: 15px;">
                    ...
                    <div style="flex: 1; display: flex; gap: 15px; align-items: stretch;">
                        <div class="flex-fill" style="flex: 1; display: flex; align-items: stretch; position: relative;">
                            <input type="hidden" name="package_type" id="package_type" value="{{ old('package_type', $brick->package_type ?? 'eceran') }}">
                            <div class="package-type-wrapper" style="flex: 1; display: flex; align-items: stretch; position: relative;">
                                <input type="text"
                                       ...
                                       value="{{ old('package_type', $brick->package_type ?? 'eceran') === 'kubik' ? 'Kubik' : 'Eceran' }}"
                    ...
                    <div style="flex: 1; display: flex; gap: 15px; align-items: stretch;">
                        ...
                        <div class="flex-fill" style="flex: 1; display: flex; align-items: stretch; position: relative;">
                            ...
                            <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                ...
                                <span class="price-suffix" id="price_per_piece_suffix" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 13px; color: #94a3b8; pointer-events: none;">/ Buah</span>
                            </div>
                            ...
                            <div style="display: flex; align-items: center; position: relative;">
                                ...
                                <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('comparison_price_per_m3', $brick->comparison_price_per_m3) }}"
                                           class="autocomplete-input"
                                    ...
                                    <span class="price-suffix" id="comparison_price_suffix" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 13px; color: #94a3b8; pointer-events: none;">/ M3</span>
                                </div>
