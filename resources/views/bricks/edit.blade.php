                    ...
                    <div style="flex: 1;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 72px 1fr 72px 1fr; gap: 8px; margin-top: 6px;">
                            <small style="color: #94a3b8; font-size: 11px;">
                                <span id="length_cm_display" style="font-weight: 600; color: #64748b;">{{ $brick->dimension_length ? number_format($brick->dimension_length, 2, '.', '') : '-' }}</span> cm
                            </small>
                            <span></span>
                            <small style="color: #94a3b8; font-size: 11px;">
                                <span id="width_cm_display" style="font-weight: 600; color: #64748b;">{{ $brick->dimension_width ? number_format($brick->dimension_width, 2, '.', '') : '-' }}</span> cm
                            </small>
                            <span></span>
                            <small style="color: #94a3b8; font-size: 11px;">
                                <span id="height_cm_display" style="font-weight: 600; color: #64748b;">{{ $brick->dimension_height ? number_format($brick->dimension_height, 2, '.', '') : '-' }}</span> cm
                            </small>
                        </div>
                    </div>
                </div>
