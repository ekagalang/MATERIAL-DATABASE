...
<div data-material-history-panel style="margin-top: 24px; display: flex; flex: 1 1 auto; min-height: 0; flex-direction: column;">
        ...
        <div data-history-stage style="display: flex; flex: 1 1 auto; min-height: 0;">
            @foreach ($historyEntries as $historyIndex => $historyEntry)
                ...
                <section
                    ...
                    <div data-history-card-body style="padding: 14px 18px; display: grid; gap: 10px; flex: 1 1 auto; min-height: 0; overflow-y: auto; overscroll-behavior: contain;">
