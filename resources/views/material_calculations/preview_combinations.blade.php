                                                ...
                                                if (is_array($rawBreakdowns)) {
                                                    foreach ($rawBreakdowns as $breakdownIndex => $breakdownRow) {
                                                        ...
                                                        $rowRequestData = is_array($breakdownRow['request_data'] ?? null)
                                                            ...
                                                            : [];
                                                        $groupWorkFloor = trim((string) ($breakdownRow['work_floor'] ?? ''));
                                                        if ($groupWorkFloor === '') {
                                                            $groupWorkFloor = $resolveFirstTaxonomyValue(
                                                                $rowRequestData['work_floors'] ?? ($rowRequestData['work_floor'] ?? ''),
                                                            );
                                                        }
                                                ...
                                                if ($isBundleDetail && empty($detailMaterialBreakdowns)) {
                                                    ...
                                                    if (is_array($rawBundleItems)) {
                                                        foreach ($rawBundleItems as $bundleItemIndex => $bundleItemRow) {
                                                            ...
                                                            $bundleWorkFloor = trim((string) ($bundleItemRow['work_floor'] ?? ''));
                                                            if ($bundleWorkFloor === '') {
                                                                $bundleWorkFloor = $resolveFirstTaxonomyValue($bundleItemRow['work_floors'] ?? '');
                                                            }
                                                ...
                                                if ($isBundleDetail && is_array($rawBreakdowns)) {
                                                    ...
                                                    foreach ($rawBreakdowns as $traceItemIndex => $traceRow) {
                                                        ...
                                                        $traceItemParams = [
                                                            ...
                                                            'row_kind' =>
                                                                $traceRequestData['row_kind'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['row_kind'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['row_kind']
                                                                    : null),
                                                            'work_floor' =>
                                                                $traceRequestData['work_floor'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['work_floor'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['work_floor']
                                                                    : null),
                                                            'work_area' =>
                                                                $traceRequestData['work_area'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['work_area'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['work_area']
                                                                    : null),
                                                            'work_field' =>
                                                                $traceRequestData['work_field'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['work_field'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['work_field']
                                                                    : null),
                                                            'work_floors' =>
                                                                $traceRequestData['work_floors'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['work_floors'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['work_floors']
                                                                    : null),
                                                            'work_areas' =>
                                                                $traceRequestData['work_areas'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['work_areas'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['work_areas']
                                                                    : null),
                                                            'work_fields' =>
                                                                $traceRequestData['work_fields'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['work_fields'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['work_fields']
                                                                    : null),
                                                            'wall_length' =>
                                                            ...
                                                            'material_type_filters' =>
                                                                $traceRequestData['material_type_filters'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['material_type_filters'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['material_type_filters']
                                                                    : null),
                                                            'material_customize_filters' =>
                                                                $traceRequestData['material_customize_filters'] ??
                                                                (isset($workItemsPayloadData[$traceItemIndex]['material_customize_filters'])
                                                                    ? $workItemsPayloadData[$traceItemIndex]['material_customize_filters']
                                                                    : null),
                                                        ];
                                            ...
                                            <div class="d-flex flex-column gap-2 align-items-center">
                                                ...
                                                <form action="{{ route('material-calculations.store') }}" method="POST"
                                                    ...
                                                    @if ($isBundleDetail)
                                                        ...
                                                        @if (empty($requestData['work_items_payload']) && !empty($item['bundle_items']))
                                                            <input type="hidden" name="work_items_payload"
                                                                value="{{ json_encode($item['bundle_items'], JSON_UNESCAPED_UNICODE) }}">
                                                        @endif
                                                        @if (empty($requestData['enable_bundle_mode']))
                                                            <input type="hidden" name="enable_bundle_mode" value="1">
                                                        @endif
                                                    @endif
                                                            ...
                                                            <div class="modal-body p-2">
                                                                @foreach ($detailMaterialBreakdowns as $detailGroup)
                                                                    @php
                                                                        ...
                                                                        $groupWorkFloor = trim((string) ($detailGroup['work_floor'] ?? ''));
                                                                        if ($groupWorkFloor === '') {
                                                                            $groupWorkFloor = $resolveGroupTaxonomyValue(
                                                                                $groupRequestData['work_floors'] ?? ($groupRequestData['work_floor'] ?? ''),
                                                                            );
                                                                        }
                                                                        ...
                                                                        $groupTaxonomyParts = [];
                                                                        if ($groupWorkFloor !== '') {
                                                                            $groupTaxonomyParts[] = 'Lantai: ' . $groupWorkFloor;
                                                                        }
                                                                        if ($groupWorkArea !== '') {
                                                                            ...
                                                                            <tbody>
                                                                                @foreach ($bundleDetailFallbackItems as $fallbackItem)
                                                                                    @php
                                                                                        ...
                                                                                        $fallbackWorkFloor = trim((string) ($fallbackItem['work_floor'] ?? ''));
                                                                                        ...
                                                                                        if ($fallbackWorkFloor !== '') {
                                                                                            $fallbackTaxonomyParts[] = 'Lantai: ' . $fallbackWorkFloor;
                                                                                        }
                                                                                        if ($fallbackWorkArea !== '') {
