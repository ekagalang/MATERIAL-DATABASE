<div class="card">
    ...
    <form action="{{ route('work-items.store') }}" method="POST" id="workItemForm">
        @csrf
            ...
            <div class="row">
                ...
                <div style="flex: 1;">
                    <textarea name="description" 
                              ...
                              style="width: 100%; padding: 10px 14px; border: 1.5px solid #e2e8f0; border-radius: 10px; font-size: 13.5px; resize: vertical;">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
