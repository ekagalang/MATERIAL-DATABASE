    ...
    if (workTypeSelector) {
        const handleWorkTypeChange = function(value) {
            ...
            if (workType) {
                ...
                if (workType.includes('brick') || workType.includes('plaster') || workType.includes('skim') || workType.includes('painting') || workType.includes('floor') || workType.includes('tile') || workType.includes('grout') || workType.includes('plinth')) {
