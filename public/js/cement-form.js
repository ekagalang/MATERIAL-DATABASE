        ...
        form.addEventListener('submit', function(e) {
            try {
                ...
                if (dimensionLength && dimensionLength.value) {
                    ...
                    const parsed = parseDecimal(dimensionLength.value);
                    dimensionLength.value = isNaN(parsed) ? '' : formatDynamicPlain(parsed);
                ...
                if (dimensionWidth && dimensionWidth.value) {
                    ...
                    const parsed = parseDecimal(dimensionWidth.value);
                    dimensionWidth.value = isNaN(parsed) ? '' : formatDynamicPlain(parsed);
                ...
                if (dimensionHeight && dimensionHeight.value) {
                    ...
                    const parsed = parseDecimal(dimensionHeight.value);
                    dimensionHeight.value = isNaN(parsed) ? '' : formatDynamicPlain(parsed);
